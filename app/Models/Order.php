    ...
    public function address()
{
    ...
    {
        $extra = is_array($this->extraOptions)
            ? $this->extraOptions
            : [];
    ...
    public function getRemainingAmountAttribute(): float
    {
        ...
        if (isset($extra['remaining_amount'])) {
    ...
    public function getRefundAmountAttribute(): float
    {
        ...
        return (float) ($extra['refund_amount'] ?? 0);
    }
    ...
    public function getInvoiceUrlAttribute(): ?string
    {
        ...
        if (\Illuminate\Support\Facades\Route::has('orders.invoice')) {
            return route(
                'orders.invoice',
        ...
        if (\Illuminate\Support\Facades\Route::has('my-orders.show')) {
            return route('my-orders.show', $this->id);
        }
        ...
        static::updated(function ($order) {
            ...
            if ($order->wasChanged('status') && $order->status === 'confirm') {
                ...
                if ($mobile) {
                    ...
                    if ($adminMobile) {
                        ...
                        $adminMessage .= "🆔 *Booking ID:* " . $order->booking_number . "\n\n";
            ...
            if ($order->wasChanged('status') && $order->status === 'cancelled') {
                ...
                if ($mobile) {
                    ...
                    if ($cancelledByCustomer) {
                        ...
                        $message .= "🆔 *Ticket ID:* " . $order->booking_number . "\n\n";
                        $message .= "📅 *Date:* " . $dateStr . "\n\n";
            ...
            if ($order->wasChanged('driver_id') && $order->driver_id && $order->vehicle_id) {
                ...
                if ($driver && $driver->mobile) {
                    ...
                    $driverMessage .= "🆔 *Booking ID:* " . $order->booking_number . "\n\n";
