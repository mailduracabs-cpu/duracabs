...
class Vehicle extends Model
{
    ...
    protected static function boot()
    {
        ...
        static::created(function ($vehicle) {
            ...
            // Send WhatsApp message to transporter/vendor when vehicle is created
            if ($vehicle->user_id && $vehicle->user && $vehicle->user->mobile) {
                $message = "🎉 *Congratulations!*\n\n";
                $message .= "Your *Attach Taxi Request* has been successfully received by *Dura Cabs.* 🚖\n\n";
                $message .= "📞 Our team will call or message you shortly for further details.\n\n";
                $message .= "For any immediate assistance, feel free to contact us at *+91 70888 73331*.\n\n";
