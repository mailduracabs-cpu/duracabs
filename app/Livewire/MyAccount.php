...
class MyAccount extends Component
{
    ...
    {
        $this->activeTab = in_array($tab, ['overview', 'profile', 'address', 'password', 'orders'], true)
            ? $tab
            : 'overview';
    ...
    public function updateProfile(): void
    {
        $this->validate([
            ...
            'gst_image' => 'nullable|image|mimes:jpg,jpeg,png,webp|max:2048',
            'aadhar_image' => 'nullable|image|mimes:jpg,jpeg,png,webp|max:2048',
        ]);
        ...
        $this->reset(['gst_image', 'aadhar_image']);
        $this->editingProfile = false;
