...
<div class="ride-shell rides-premium-shell font-poppins rounded-3xl py-3 sm:py-5">
    ...
    <?php $__env->startSection('description', $seoDescription); ?>
    ...
    <?php $__env->startPush('schema'); ?>
        <script type="application/ld+json">
            <?php echo json_encode($serviceSchema, JSON_UNESCAPED_SLASHES | JSON_UNESCAPED_UNICODE | JSON_PRETTY_PRINT); ?>
    ...
    <nav class="product-breadcrumb mb-3 mt-2 text-sm text-slate-600" aria-label="Breadcrumb">
        <ol class="flex flex-wrap items-center gap-2">
            <li><a href="<?php echo e(url('/')); ?>" class="hover:text-sky-600">Home</a></li>
            <li aria-hidden="true">/</li>
            <li><a href="<?php echo e(url('/routes')); ?>" class="hover:text-sky-600">Cab Routes</a></li>
            <li aria-hidden="true">/</li>
            <li class="font-semibold text-slate-900" aria-current="page"><?php echo e($routeName); ?></li>
        </ol>
    </nav>
    ...
    <header class="product-premium-header premium-hero-animate mb-5">
        <h1 class="text-2xl font-extrabold leading-tight text-slate-900 sm:text-3xl">
            <?php echo e($routeName); ?> <?php echo e($tripLabel); ?> Booking
        </h1>
        <p class="mt-2 max-w-4xl text-sm leading-6 text-slate-600 sm:text-base"><?php echo e($seoDescription); ?></p>
    </header>
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                            ...
                            <!--[if BLOCK]><![endif]--><?php if($otpError): ?><p class="rounded-lg bg-red-50 px-3 py-2 text-sm text-red-700"><?php echo e($otpError); ?></p><?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                    ...
                    <?php else: ?>
                        <p class="text-sm text-slate-600">+91 <?php echo e($mobileNumber); ?> par bheja gaya 4 digit OTP enter karein.</p>
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
    ...
    <!--[if BLOCK]><![endif]--><?php if($showEditTripModal): ?>
                ...
                <form wire:submit.prevent="updateTripSearch" class="grid gap-5 p-6 md:grid-cols-2">
                    ...
                    <div>
                        ...
                        <select wire:model="editPickupId" class="w-full rounded-xl border-slate-300">
                            ...
                            <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $allCities; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $city): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><option value="<?php echo e($city->id); ?>"><?php echo e($city->name); ?></option><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><!--[if ENDBLOCK]><![endif]-->
                        </select>
                        <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['editPickupId'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                    ...
                    <!--[if BLOCK]><![endif]--><?php if($editRideType === 'one_way'): ?>
                    <div>
                        ...
                        <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['editDropId'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?><p class="mt-1 text-sm text-red-600"><?php echo e($message); ?></p><?php unset($message);
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                    ...
                    <div>
                        ...
                        <input type="date" min="<?php echo e(now()->toDateString()); ?>" wire:model="editDate" class="w-full rounded-xl border-slate-300">
                        <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['editDate'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?><p class="mt-1 text-sm text-red-600"><?php echo e($message); ?></p><?php unset($message);
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                    ...
                    <div>
                        ...
                        <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['editTime'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?><p class="mt-1 text-sm text-red-600"><?php echo e($message); ?></p><?php unset($message);
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                    ...
                    <!--[if BLOCK]><![endif]--><?php if($editRideType === 'self_drive'): ?>
        ...
        <div class="mx-auto max-w-7xl px-1 sm:px-3">
                    ...
                    <div class="flex min-w-0 items-center gap-3">
                        ...
                        <div class="min-w-0">
                            ...
                            <div class="mt-0.5 flex min-w-0 items-center gap-2 text-white">
                                <span class="truncate text-sm lg:text-base"><?php echo e($ride->brand->name); ?></span>

                                <!--[if BLOCK]><![endif]--><?php if($ride->ride_type === 'one_way'): ?>
                                    <span class="shrink-0 text-lg">→</span>
                                    <span class="truncate text-sm lg:text-base"><?php echo e($cityTo->name); ?></span>
                                <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                            </div>
                        </div>
                    </div>
                ...
                <div class="product-trip-type">
                    ...
                    <div>
                        ...
                        <p class="uppercase main-color-text">
                            <?php echo e($ride->ride_type === 'one_way' ? 'Oneway' : ucfirst(str_replace('_', ' ', $ride->ride_type))); ?>
            ...
            <div class="product-main-layout lg:flex flex-wrap mb-20 -mx-3">
                ...
                <main class="product-content w-full px-3 lg:w-3/4">
                    <div class="mb-4">
                        <div
                            class="product-toolbar surface rides-toolbar flex items-center justify-between px-4 py-3">
                            <div><p class="text-sm font-extrabold text-slate-900"><?php echo e(count($prices)); ?> Cab Packages Available</p><p class="text-xs text-slate-500">Ride page jaisa premium vehicle selection</p></div>
                    ...
                    <div class="product-package-list rides-results rides-premium-results grid items-center relative">
                        ...
                        <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $prices; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $price): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <article wire:key="product-price-<?php echo e($price->id ?? $loop->index); ?>" class="ride-package-card product-ride-card">
                                <div class="ride-package-media">
                                    <span class="ride-package-badge <?php echo e($badgeClass); ?>"><?php echo e($badgeLabel); ?></span>
                                    <a href="/route/<?php echo e($ride->slug); ?>" aria-label="View <?php echo e($price->category->name); ?> details">
                                        <img src="<?php echo e(url('storage')); ?>/<?php echo e($price->category->image); ?>"
                                            alt="<?php echo e($price->category->name); ?>"
                                ...
                                <div class="ride-package-content">
                                    ...
                                    <p class="ride-package-model">
                                        <?php echo e($price->category->passanger_capacity); ?>

                                        <?php echo e($price->category->model ?: $ride->name); ?> or similar
                                    </p>
                                    ...
                                    <div class="ride-package-features">
                                        ...
                                        <!--[if BLOCK]><![endif]--><?php if($ride->ride_type === 'self_drive'): ?>
                                            <span><i class="fa-solid fa-car-side"></i> Clean Car</span>
                                        <?php else: ?>
                                ...
                                <div class="ride-package-price">
                                    <!--[if BLOCK]><![endif]--><?php if($fareUnlocked): ?>
                                        <!--[if BLOCK]><![endif]--><?php if($price->max_price > $price->price): ?>
                                            <del><?php echo e(Number::currency($price->max_price, 'INR')); ?></del>
                                        <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                                        <strong>
                                            <?php echo e(Number::currency($price->price, 'INR')); ?>
                                    ...
                                    <?php else: ?>
                                        <button type="button" wire:click="openFareGate" class="ride-price-lock" aria-label="Verify mobile to view exact fare">
                                            <span class="ride-price-lock-old"><?php echo e(Number::currency($price->max_price, 'INR')); ?></span>
                                            <span class="ride-price-lock-main"><?php echo e(Number::currency($price->price, 'INR')); ?></span>
                                    ...
                                    <!--[if BLOCK]><![endif]--><?php if($fareUnlocked): ?>
                                        <!--[if BLOCK]><![endif]--><?php if($ride->ride_type === 'one_way'): ?>
                                            <button type="button"
                                                onclick="showFareSummaryOneWay('<?php echo e(addslashes($ride->name)); ?>', '<?php echo e(addslashes($price->category->name)); ?>', <?php echo e($price->price); ?>, <?php echo e($price->max_price); ?>, <?php echo e($ride->toll_tax ?? 0); ?>, <?php echo e($ride->km_limit ?? 0); ?>, <?php echo e($ride->hr_limit ?? 0); ?>, <?php echo e($ride->extra_km_charge ?? 0); ?>, <?php echo e($ride->extra_hr_charge ?? 0); ?>)"
                                                class="ride-fare-icon-button">
                                                <i class="fa-solid fa-circle-info"></i><span>Fare details</span>
                                            </button>
                                        <?php elseif($ride->ride_type === 'local'): ?>
                                            <button type="button"
                                                onclick="showFareSummaryLocal('<?php echo e(addslashes($ride->name)); ?>', '<?php echo e(addslashes($price->category->name)); ?>', <?php echo e($price->price); ?>, <?php echo e($price->max_price); ?>, 1, 'Local Package', <?php echo e($ride->extra_km_charge ?? 0); ?>, <?php echo e($ride->extra_hr_charge ?? 0); ?>, <?php echo e($ride->driver_allowances ?? 0); ?>)"
                                                class="ride-fare-icon-button">
                                                <i class="fa-solid fa-circle-info"></i><span>Fare details</span>
                                            </button>
                                        <?php else: ?>
                                            <button type="button"
                                                onclick="showFareSummarySelfDrive('<?php echo e(addslashes($ride->name)); ?>', '<?php echo e(addslashes($price->category->name)); ?>', <?php echo e($price->price); ?>, <?php echo e($price->max_price); ?>, 1, '<?php echo e($price->category->security ?? 0); ?>')"
                                                class="ride-fare-icon-button">
                                                <i class="fa-solid fa-circle-info"></i><span>Fare details</span>
                                            </button>
                                        <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
        ...
        <div class="mx-auto max-w-7xl space-y-8 px-4 sm:px-6 lg:px-8">
            ...
            <div class="overflow-hidden rounded-3xl border border-slate-200 bg-white shadow-sm">
                ...
                <div class="grid gap-4 p-5 sm:grid-cols-2 sm:p-8 lg:grid-cols-4">
                    ...
                    <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $bookingSteps; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $step): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="group rounded-2xl border border-slate-200 bg-slate-50 p-5 transition hover:-translate-y-1 hover:border-sky-200 hover:bg-white hover:shadow-lg">
                            ...
                            <h3 class="mt-4 text-base font-extrabold text-slate-900"><?php echo e($step[1]); ?></h3>
                            <p class="mt-2 text-sm leading-6 text-slate-600"><?php echo e($step[2]); ?></p>
                        </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><!--[if ENDBLOCK]><![endif]-->
                </div>
            </div>
            ...
            <div class="grid gap-8 lg:grid-cols-[minmax(0,1.7fr)_minmax(280px,0.8fr)]">
                <article class="rounded-3xl border border-slate-200 bg-white p-5 shadow-sm sm:p-8">
                    ...
                    <h2 class="mt-4 text-2xl font-black leading-tight text-slate-950 sm:text-3xl lg:text-4xl">
                        <?php echo e($routeName); ?> <?php echo e($tripLabel); ?> – Affordable Booking with Dura Cabs
                    </h2>
                    ...
                    <div class="mt-8 rounded-2xl border border-sky-100 bg-sky-50/70 p-5">
                        <div class="flex items-center gap-3">
                            ...
                            <div>
                                ...
                                <p class="text-sm text-slate-600">Useful journey details for <?php echo e($ride->name); ?>.</p>
                            </div>
                        </div>
                        ...
                        <dl class="mt-5 grid gap-3 sm:grid-cols-2">
                            <div class="rounded-xl bg-white p-4 ring-1 ring-slate-200">
                                ...
                                <dd class="mt-1 font-bold text-slate-900"><?php echo e($ride->name); ?></dd>
                            </div>
                            <div class="rounded-xl bg-white p-4 ring-1 ring-slate-200">
                                <dt class="text-xs font-bold uppercase tracking-wide text-slate-500">Estimated route</dt>
                                <dd class="mt-1 font-bold text-slate-900"><?php echo e($ride->hr_limit); ?> Hours · <?php echo e($ride->km_limit); ?> KM</dd>
                            </div>
                        </dl>
                    </div>
                </article>
                        ...
                        <div class="mt-5 space-y-4">
                            <!--[if BLOCK]><![endif]--><?php $__currentLoopData = [
                                ...
                                <div class="flex gap-3">
                                    ...
                                    <p class="text-sm font-medium leading-6 text-slate-700"><?php echo e($benefit); ?></p>
                                </div>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><!--[if ENDBLOCK]><![endif]-->
                        </div>
                    </div>
            ...
            <section class="rounded-3xl border border-slate-200 bg-white p-5 shadow-sm sm:p-8">
                <div class="flex flex-col gap-2 sm:flex-row sm:items-end sm:justify-between">
                    <div>
                        ...
                        <h2 class="mt-2 text-2xl font-black text-slate-950"><?php echo e($ride->name); ?> Cab Fare & Vehicle Options</h2>
                    </div>
                            ...
                            <tbody class="divide-y divide-slate-100 bg-white">
                                <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $prices; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr class="transition hover:bg-sky-50/60">
                                        <td class="whitespace-nowrap px-5 py-4 font-bold text-slate-900"><?php echo e($item->category->name); ?></td>
                                        <td class="whitespace-nowrap px-5 py-4 text-slate-600"><?php echo e($item->category->model); ?></td>
                                        <td class="whitespace-nowrap px-5 py-4 text-slate-600"><?php echo e($item->category->passanger_capacity); ?></td>
                                        <td class="whitespace-nowrap px-5 py-4 text-slate-600"><?php echo e($item->category->luggage_capacity); ?> Bags</td>
                                        <td class="whitespace-nowrap px-5 py-4 font-semibold text-slate-700"><?php echo e(Number::currency($item->category->km_charge, 'INR')); ?></td>
                                        <td class="whitespace-nowrap px-5 py-4 font-extrabold text-sky-700"><?php echo e(Number::currency($item->price, 'INR')); ?></td>
                                    </tr>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><!--[if ENDBLOCK]><![endif]-->
                            </tbody>
                        </table>
                    ...
                    <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $faqs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $faq): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <details class="group py-1">
                            <summary class="flex cursor-pointer list-none items-center justify-between gap-4 py-5 font-bold text-slate-900 outline-none focus-visible:ring-2 focus-visible:ring-sky-500">
                                <span><?php echo e($index + 1); ?>. <?php echo e($faq['question']); ?></span>
            ...
            <!--[if BLOCK]><![endif]--><?php if($links->count()): ?>
                <section class="rounded-3xl border border-slate-200 bg-white p-5 shadow-sm sm:p-8">
                    <div>
                        <p class="text-xs font-bold uppercase tracking-[0.18em] text-sky-600">Explore more</p>
                        <h2 class="mt-2 text-2xl font-black text-slate-950">Popular One Way Routes from <?php echo e($ride->brand->name); ?></h2>
                    </div>
                    ...
                    <div class="mt-6 grid gap-3 sm:grid-cols-2 lg:grid-cols-3">
                        <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $links; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $link): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <a wire:navigate href="<?php echo e($link->url); ?>" class="group flex items-center justify-between rounded-2xl border border-slate-200 bg-slate-50 px-4 py-4 text-sm font-bold text-slate-800 transition hover:-translate-y-0.5 hover:border-sky-200 hover:bg-white hover:text-sky-700 hover:shadow-md">
...
</div><?php /**PATH C:\xampp\htdocs\duracabs\resources\views/livewire/product-detailed-page.blade.php ENDPATH**/ ?>