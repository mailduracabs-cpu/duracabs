    ...
    <!--[if BLOCK]><![endif]--><?php if($paginator->hasPages()): ?>
        <nav role="navigation" aria-label="Pagination Navigation" class="flex justify-between">
            <span>
                ...
                <?php else: ?>
                    <!--[if BLOCK]><![endif]--><?php if(method_exists($paginator,'getCursorName')): ?>
...
<?php /**PATH C:\xampp\htdocs\duracabs\vendor\livewire\livewire\src\Features\SupportPagination/views/simple-tailwind.blade.php ENDPATH**/ ?>