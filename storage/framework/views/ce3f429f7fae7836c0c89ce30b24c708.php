        ...
        >
            <div class="mb-4 flex flex-col gap-3 rounded-2xl border border-sky-100 bg-sky-50/70 p-4 sm:flex-row sm:items-center sm:justify-between">
                ...
                <span class="inline-flex w-fit items-center gap-2 rounded-full bg-white px-3 py-2 text-xs font-bold text-sky-700 shadow-sm">
                    ...
                    <?php echo e(1 + count($tripCities ?? [])); ?> Destination<?php echo e((1 + count($tripCities ?? [])) === 1 ? '' : 's'); ?>
            ...
            <div class="grid grid-cols-1 items-start gap-3 lg:grid-cols-[1.25fr_1.25fr_1fr_1fr_1fr_150px]">
                ...
                <div class="relative">
                    ...
                    <!--[if BLOCK]><![endif]--><?php if($this->hasError('queryFrom')): ?>
                        <p class="mt-1 text-xs font-medium text-red-600"><?php echo e($this->getError('queryFrom')); ?></p>
                    <?php endif; ?>
                        ...
                        <div data-suggestions class="absolute left-0 top-full z-[1000000] mt-2 max-h-56 w-full overflow-y-auto rounded-xl border border-slate-200 bg-white p-1.5 shadow-2xl">
                            <!--[if BLOCK]><![endif]--><?php $__currentLoopData = ($dataFrom ?? []); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $city): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                >
                                    ...
                                    <span class="leading-5"><?php echo e($city['description']); ?></span>
                                </button>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><!--[if ENDBLOCK]><![endif]-->
                        </div>
                    <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                ...
                <div class="relative">
                    ...
                    <!--[if BLOCK]><![endif]--><?php if($this->hasError('queryTo')): ?>
                        <p class="mt-1 text-xs font-medium text-red-600"><?php echo e($this->getError('queryTo')); ?></p>
                    <?php endif; ?>
                ...
                <div>
                    ...
                    <input
                        ...
                        required
                        class="h-14 w-full rounded-xl border bg-slate-50 px-3 text-sm font-bold text-slate-900 outline-none transition focus:bg-white focus:ring-4
                        <?php echo e($this->hasError('date') ? 'border-red-400 focus:border-red-500 focus:ring-red-100' : 'border-slate-200 focus:border-sky-500 focus:ring-sky-100'); ?>"
                    >
                    <!--[if BLOCK]><![endif]--><?php if($this->hasError('date')): ?>
                        <p class="mt-1 text-xs font-medium text-red-600"><?php echo e($this->getError('date')); ?></p>
                    <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                </div>
                ...
                <div>
                    ...
                    <input
                        ...
                        id="round-end-date"
                        wire:model="dateto"
                        min="<?php echo e($date ?: date('Y-m-d')); ?>"
                        required
                        class="h-14 w-full rounded-xl border bg-slate-50 px-3 text-sm font-bold text-slate-900 outline-none transition focus:bg-white focus:ring-4
                        <?php echo e($this->hasError('dateto') ? 'border-red-400 focus:border-red-500 focus:ring-red-100' : 'border-slate-200 focus:border-sky-500 focus:ring-sky-100'); ?>"
                    >
                    <!--[if BLOCK]><![endif]--><?php if($this->hasError('dateto')): ?>
                        <p class="mt-1 text-xs font-medium text-red-600"><?php echo e($this->getError('dateto')); ?></p>
                    <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                </div>
                ...
                <div>
                    ...
                    <input
                        ...
                        required
                        class="h-14 w-full rounded-xl border bg-slate-50 px-3 text-sm font-bold text-slate-900 outline-none transition focus:bg-white focus:ring-4
                        <?php echo e($this->hasError('time') ? 'border-red-400 focus:border-red-500 focus:ring-red-100' : 'border-slate-200 focus:border-sky-500 focus:ring-sky-100'); ?>"
                    >
                    <!--[if BLOCK]><![endif]--><?php if($this->hasError('time')): ?>
                        <p class="mt-1 text-xs font-medium text-red-600"><?php echo e($this->getError('time')); ?></p>
                    <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                </div>
            ...
            <div class="mt-4 space-y-3">
                <!--[if BLOCK]><![endif]--><?php $__currentLoopData = ($tripCities ?? []); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $tripCity): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div wire:key="multi-trip-city-<?php echo e($index); ?>" class="rounded-2xl border border-slate-200 bg-slate-50/70 p-3 sm:p-4">
                        <div class="flex items-start gap-3">
                            <div class="relative min-w-0 flex-1">
                                <label for="trip-city-<?php echo e($index); ?>" class="mb-1.5 block text-xs font-bold uppercase tracking-wide text-slate-600">
                                    Destination <?php echo e($index + 2); ?>
                                ...
                                <div class="relative">
                                    ...
                                    <input
                                        type="text"
                                        id="trip-city-<?php echo e($index); ?>"
                                        wire:model.live.debounce.350ms="tripCities.<?php echo e($index); ?>.search"
                                        ...
                                        <?php echo e($this->hasError('tripCities.' . $index)
                                            ? 'border-red-400 focus:border-red-500 focus:ring-red-100'
                                            : 'border-slate-200 focus:border-violet-500 focus:ring-violet-100'); ?>"
                                    >
                                </div>

                                <!--[if BLOCK]><![endif]--><?php if($this->hasError('tripCities.' . $index)): ?>
                                    <p class="mt-1 text-xs font-medium text-red-600"><?php echo e($this->getError('tripCities.' . $index)); ?></p>
                                <?php endif; ?><!--[if ENDBLOCK]><![endif]-->

                                <!--[if BLOCK]><![endif]--><?php if(!empty($tripCity['suggestions'])): ?>
                                    <div data-suggestions class="absolute left-0 top-full z-[1000000] mt-2 max-h-56 w-full overflow-y-auto rounded-xl border border-slate-200 bg-white p-1.5 shadow-2xl">
                                        <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $tripCity['suggestions']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $city): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <button
                                                type="button"
                                                wire:click="selectTripCity(<?php echo e($index); ?>, '<?php echo e($city['place_id']); ?>')"
                            ...
                            <button
                                type="button"
                                wire:click="removeTripCity(<?php echo e($index); ?>)"
                                ...
                                aria-label="Remove destination <?php echo e($index + 2); ?>"
            ...
            <div class="mt-4 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                <button
                    ...
                    <?php if(count($tripCities ?? []) >= $maxTripCities): echo 'disabled'; endif; ?>
                ...
                <div class="inline-flex items-center gap-2 text-xs font-semibold text-slate-500 sm:text-sm">
                    ...
                    Final route automatically returns to <?php echo e($queryFrom ?: 'pickup city'); ?>.
                </div>
            </div>

            <!--[if BLOCK]><![endif]--><?php if($this->hasError('tripCities')): ?>
                <p class="mt-3 text-xs font-medium text-red-600"><?php echo e($this->getError('tripCities')); ?></p>
            <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
