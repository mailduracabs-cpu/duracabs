            ...
            <div id="navbar-collapse-with-animation"
                ...
                <div
                    ...
                    <div
                        ...
                        <a wire:navigate
                            class="font-medium <?php echo e(request()->is('/') ? 'text-sky-100' : 'text-white '); ?> hover:text-blue-800 py-3 md:py-6 dark:text-blue-500 dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600"
                            href="/" aria-current="page">Home</a>

                        <a 
                            class="font-medium <?php echo e(request()->is('cab-categories') ? 'text-sky-100' : 'text-white '); ?> hover:text-blue-800 py-3 md:py-6 dark:text-gray-400 dark:hover:text-gray-500 dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600"
                            href="tel:7088873331">
                            Call:+91-7088873331
                        </a>

                        <a
                            class="font-medium <?php echo e(request()->is('rides') ? 'text-sky-100' : 'text-white '); ?> hover:text-blue-800 py-3 md:py-6 dark:text-gray-400 dark:hover:text-gray-500 dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600"
                        ...
                        <a wire:navigate
                            class="font-medium flex items-center <?php echo e(request()->is('cart') ? 'text-sky-100' : 'text-white '); ?>   hover:text-blue-600 py-3 md:py-6 dark:text-gray-400 dark:hover:text-gray-500 dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600"
...
<?php /**PATH /var/www/duracabs/duracabs/resources/views/livewire/partials/navbar.blade.php ENDPATH**/ ?>