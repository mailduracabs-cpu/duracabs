<div class="w-full max-w-[70rem]  px-4 sm:px-6 lg:px-8 mx-auto">
    <?php $__env->startSection('title', 'Duracabs: Trusted Online cab Booking Services in India'); ?>
                ...
                <div class="lg:flex mb-5 -mx-3">
                    ...
                    <div class="w-full pr-2 flex  p-2 md:mt-0 mt-2 rounded-r border-2 border-[#1e9cfd]">
                        ...
                        <div class="">
                            ...
                            <div class="flex">
                                <p class="uppercase main-color-text"><?php echo e($tab); ?> </p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <!--[if BLOCK]><![endif]--><?php if($nameTo): ?>
                <div
                    ...
                    <div class="flex mt-3">
                        ...
                        &nbsp; <p>PickUp City : </p> &nbsp; &nbsp; <span><?php echo e($nameTo); ?></span>
                    ...
                    <div class="flex mt-3">
                        ...
                        &nbsp; <p>PickUp Date : </p> &nbsp; &nbsp; <span><?php echo e($date); ?></span>
                    ...
                    <!--[if BLOCK]><![endif]--><?php if($tab === 'local'): ?>
                        <div class="flex mt-3">
                            ...
                            &nbsp; <p>Plan : </p> &nbsp; &nbsp; <span><?php echo e($plan); ?></span>
                    ...
                    <div class="w-full px-3 lg:w-3/4">
                        <div class="px-3 mb-4">
                            <div
                                ...
                                <div class="text-2xl"> Search Result (<?php echo e(count($categories)); ?>)</div>
                                ...
                                <div
                                    ...
                                    <div class="lg:flex justify-between">
                                        ...
                                        <div class="flex items-center justify-center ">
                                            ...
                                            <img src="<?php echo e(url('storage')); ?>/<?php echo e($category->image); ?>"
                                        ...
                                        <div class="p-3 text-center lg:w-1/4 w-full">
                                            ...
                                            <div class="text-lg text-center">
                                                ...
                                                <p class="text-black-600 text-2xl font-bold dark:text-black-600">
                                                    ...
                                                    <?php echo e(($kmValue / 1000) * ($days === 0 ? 2 : 2) > ($days === 0 ? 1 : $days + 1) * $category->range
                                            ...
                                            <div class="flex justify-center p-1 ">
                                                ...
                                                <a wire:click.prevent='addToCartReturn([<?php echo e($category->id); ?>,"<?php echo e($nameTo); ?>", "<?php echo e($cityFrom); ?>", "<?php echo e(($kmValue / 1000) * ($days === 0 ? 2 : 2) > ($days === 0 ? 1 : $days + 1) * $category->range
                                                    ? ($kmValue / 1000) * ($days === 0 ? 2 : 2) * $category->km_charge +
                                                        $category->driver_charge * ($days === 0 ? 0 : $days)
                                                    : ($days === 0 ? 1 : $days + 1) * $category->range * $category->km_charge +
                                                        $category->driver_charge * ($days === 1 ? 1 : $days)); ?>","<?php echo e($date); ?>","<?php echo e($dateto); ?>","<?php echo e($time); ?>","<?php echo e($tab); ?>","<?php echo e(round(($kmValue / 1000) * ($days === 0 ? 2 : 2) > $category->range * ($days === 0 ? 1 : $days + 1) * $category->range ? ($kmValue / 1000) * ($days === 0 ? 2 : 2) : $category->range * ($days === 0 ? 1 : $days + 1))); ?>","<?php echo e($category->new_vehicle); ?>","<?php echo e($category->pet_friendly); ?>","<?php echo e($category->roof_career); ?>"])'
                                                    href="#"
                                            ...
                                            <button
                                                onclick="showFareSummary(<?php echo e($category->id); ?>, '<?php echo e($category->name); ?>', <?php echo e(($kmValue / 1000) * ($days === 0 ? 2 : 2) > ($days === 0 ? 1 : $days + 1) * $category->range
                                                    ? ($kmValue / 1000) * ($days === 0 ? 2 : 2) * $category->km_charge +
                                                        $category->driver_charge * ($days === 0 ? 0 : $days)
                                                    : ($days === 0 ? 1 : $days + 1) * $category->range * $category->km_charge +
                                                        $category->driver_charge * ($days === 1 ? 1 : $days)); ?>, <?php echo e($category->km_charge); ?>, <?php echo e($category->driver_charge); ?>, <?php echo e($category->range); ?>, <?php echo e(round(
                                                    ($kmValue / 1000) * ($days === 0 ? 2 : $days + 1) > ($days === 0 ? 1 : $days + 1) * $category->range
                                                        ? ($kmValue / 1000) * ($days === 0 ? 2 : $days + 1)
                                                        : ($days === 0 ? 1 : $days + 1) * $category->range,
                                                )); ?>, <?php echo e($days === 0 ? 1 : $days); ?>)"
                                        ...
                                        <div
                                            ...
                                            <div class="lg:flex  justify-between  ">
                                                <div class="relative lg:w-1/4">
                                                    <a href="/route/<?php echo e($ride->slug); ?>"
                                                        class="flex items-center justify-center h-full w-full">
                                                        <img src="<?php echo e(url('storage')); ?>/<?php echo e($price->category->image); ?>"
                                                            alt="<?php echo e($ride->name); ?>" title="<?php echo e($ride->name); ?>"
                                                            class="object-contain lg:w-30 w-full h-16 mx-auto">
                                                    </a>
                                                    ...
                                                    <div
                                                        ...
                                                        <div
                                                            ...
                                                            <p class="text-[10px] leading-4 text-center w-3/4 mt-2">
                                                                <?php echo e($price->category->passanger_capacity); ?> seater <br>
                                                                <?php echo e($price->category->model); ?> modal
                                                    ...
                                                    <div class="p-3 text-center lg:w-1/4 w-full">
                                                        ...
                                                        <div class="text-lg text-center">
                                                            ...
                                                            <p
                                                                ...
                                                                <?php echo e(Number::currency($price->price, 'INR')); ?></p>
                                                        </div>
                                                        <div class="flex justify-center p-1 ">

                                                            <a wire:click.prevent='addToCartOneWay([<?php echo e($ride->id); ?>,"<?php echo e($time); ?>","<?php echo e($tab); ?>","<?php echo e($date); ?>", "<?php echo e($price->price); ?>","<?php echo e($ride->name); ?>", "<?php echo e($price->category->name); ?>", "<?php echo e($ride->toll_tax); ?>","<?php echo e($price->category->new_vehicle); ?>","<?php echo e($price->category->pet_friendly); ?>","<?php echo e($price->category->roof_career); ?>"])'
                                                                href="#"
                                                        ...
                                                        <button
                                                            onclick="showFareSummaryOneWay('<?php echo e($ride->name); ?>', '<?php echo e($price->category->name); ?>', <?php echo e($price->price); ?>, <?php echo e($price->max_price); ?>,<?php echo e($ride->toll_tax); ?>,<?php echo e($ride->km_limit); ?>,<?php echo e($ride->hr_limit); ?>,<?php echo e($ride->extra_km_charge); ?>,<?php echo e($ride->extra_hr_charge); ?>)"
                                                            class="w-full inline-flex items-center justify-center px-3 py-2 text-xs font-semibold text-blue-600 bg-blue-50 border border-blue-200 rounded-lg hover:bg-blue-100 hover:text-blue-700 transition duration-200 mt-2">
                                                ...
                                                <!--[if BLOCK]><![endif]--><?php if(!$tab): ?>
                                                    <div class="p-3 text-center lg:w-1/3 w-full">
                                                        <div class="text-lg text-center">
                                                            <p
                                                                class="text-base font-normal text-gray-500 line-through dark:text-gray-400">
                                                                <?php echo e(Number::currency($price->max_price, 'INR')); ?>
                                                        ...
                                                        <div class="flex justify-center p-1 ">
                                                            ...
                                                            <a wire:click.prevent='addToCart(<?php echo e($ride->id); ?>)'
                                                                href="#"
                                                                class="text-white text-xm bg-sky-500 hover:bg-sky-900 p-2 shadow-2xl shadow-black rounded-full flex items-center space-x-2 dark:text-gray-400 hover:text-b-500 dark:hover:text-red-300">
                                                                <span>Book Now</span>
                                                            </a>
                                                        ...
                                                        <button
                                                            onclick="showFareSummaryOneWay('<?php echo e($ride->name); ?>', '<?php echo e($price->category->name); ?>', <?php echo e($price->price); ?>, <?php echo e($price->max_price); ?>)"
                                                ...
                                                <!--[if BLOCK]><![endif]--><?php if($tab === 'self_drive'): ?>
                                                    <div class="p-3 text-center lg:w-1/4 w-full">
                                                        ...
                                                        <div class="text-lg text-center">
                                                            <p
                                                                class="text-base font-normal text-gray-500 line-through dark:text-gray-400">
                                                                <?php echo e(Number::currency($price->max_price * $days, 'INR')); ?>

                                                            </p>
                                                            <p
                                                                class="text-black-600 text-2xl font-bold dark:text-black-600">
                                                                <?php echo e(Number::currency($price->price * $days, 'INR')); ?>

                                                            </p>
                                                        </div>
                                                        <div class="flex justify-center p-1 ">

                                                            <a wire:click.prevent='addToCartSelfDrive([<?php echo e($ride->id); ?>,"<?php echo e($time); ?>","<?php echo e($endTime); ?>","<?php echo e($tab); ?>","<?php echo e($date); ?>","<?php echo e($dateto); ?>",<?php echo e($price->price * $days); ?>,<?php echo e($price->category->security); ?>])'
                                                                href="#"
                                                                class="text-white text-xm bg-sky-500 hover:bg-sky-900 p-2 shadow-2xl shadow-black rounded-full flex items-center space-x-2 dark:text-gray-400 hover:text-b-500 dark:hover:text-red-300">
                                                                <span>Book Now</span>
                                                            </a>
                                                        ...
                                                        <button
                                                            onclick="showFareSummarySelfDrive('<?php echo e($ride->name); ?>', '<?php echo e($price->category->name); ?>', <?php echo e($price->price * $days); ?>, <?php echo e($price->max_price * $days); ?>, <?php echo e($days); ?>,'<?php echo e($price->category->security); ?>')"
                                                            class="w-full inline-flex items-center justify-center px-3 py-2 text-xs font-semibold text-blue-600 bg-blue-50 border border-blue-200 rounded-lg hover:bg-blue-100 hover:text-blue-700 transition duration-200 mt-2">
                                                ...
                                                <!--[if BLOCK]><![endif]--><?php if($tab === 'local'): ?>
                                                    <div class="p-3 text-center">
                                                        ...
                                                        <div class="text-lg text-center">
                                                            <p
                                                                class="text-base font-normal text-gray-500 line-through dark:text-gray-400">
                                                                <?php echo e(Number::currency($price->max_price * $cars, 'INR')); ?>

                                                            </p>
                                                            <p
                                                                class="text-black-600 text-2xl font-bold dark:text-black-600">
                                                                <?php echo e(Number::currency($price->price * $cars, 'INR')); ?>

                                                            </p>
                                                        </div>
                                                        <div class="flex justify-center p-1 ">

                                                            <a wire:click.prevent='addToCartLocal([<?php echo e($ride->id); ?>,"<?php echo e($time); ?>","<?php echo e($tab); ?>","<?php echo e($date); ?>","<?php echo e($plan); ?>","<?php echo e($cars); ?>","<?php echo e($price->price * $cars); ?>","<?php echo e($ride->name); ?>", "<?php echo e($price->category->name); ?>","<?php echo e($ride->toll_tax); ?>","<?php echo e($ride->category->new_vehicle); ?>","<?php echo e($ride->category->pet_friendly); ?>","<?php echo e($ride->category->roof_career); ?>"])'
                                                                href="#"
                                                                class="text-white text-xm bg-sky-500 hover:bg-sky-900 p-2 shadow-2xl shadow-black rounded-full flex items-center space-x-2 dark:text-gray-400 hover:text-b-500 dark:hover:text-red-300">
                                                                <span>Book Now</span>
                                                            </a>
                                                        ...
                                                        <button
                                                            onclick="showFareSummaryLocal('<?php echo e($ride->name); ?>', '<?php echo e($price->category->name); ?>', <?php echo e($price->price * $cars); ?>, <?php echo e($price->max_price * $cars); ?>, <?php echo e($cars); ?>, '<?php echo e($plan); ?>',<?php echo e($ride->extra_km_charge); ?>,<?php echo e($ride->extra_hr_charge); ?>,<?php echo e($ride->driver_allowances); ?>)"
                                                            class="w-full inline-flex items-center justify-center px-3 py-2 text-xs font-semibold text-blue-600 bg-blue-50 border border-blue-200 rounded-lg hover:bg-blue-100 hover:text-blue-700 transition duration-200 mt-2">
        ...
        <div class="fixed inset-0 bg-gray-600 bg-opacity-50 overflow-y-auto h-full w-full z-50"
            ...
            <div class="relative top-20 mx-auto p-5 border w-11/12 max-w-4xl shadow-lg rounded-lg bg-white">
                ...
                <form wire:submit='updateQuery' autocomplete="off"
                    class="<?php echo e($edit_ride_type == 'one_way' ? 'block' : 'hidden'); ?> bg-white rounded-xl pt-5 px-2">
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                ...
                <!-- Return Form -->
                <form wire:submit='updateQuery' autocomplete="off"
                    class="<?php echo e($edit_ride_type == 'return' ? 'block' : 'hidden'); ?>">
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                ...
                <!-- Local Form -->
                <form wire:submit='updateQuery' autocomplete="off"
                    class="<?php echo e($edit_ride_type == 'local' ? 'block' : 'hidden'); ?>">
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                ...
                <!-- Self Drive Form -->
                <form wire:submit='updateQuery' autocomplete="off"
                    class="<?php echo e($edit_ride_type == 'self_drive' ? 'block' : 'hidden'); ?>">
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4">
                        <!-- From City -->
                        <div class="relative">
                            <label class="block text-sm font-semibold text-gray-700 mb-2">From City</label>
...
<?php /**PATH /var/www/duracabs/duracabs/resources/views/livewire/rides-page.blade.php ENDPATH**/ ?>