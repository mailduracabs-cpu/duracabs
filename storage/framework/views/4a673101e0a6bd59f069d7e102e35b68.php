<div
    class="premium-motion-page rides-premium-page <?php echo e(($tab ?? null) === 'self_drive' ? 'self-drive-mode' : ''); ?> w-full max-w-[86rem] px-3 sm:px-5 lg:px-6 mx-auto"
    id="rides-page"
    x-data="{
        otpSeconds: 0,
        galleryOpen: false,
...
>
    ...
    fetchpriority="<?php echo e($loop->first ? 'high' : 'auto'); ?>"
    decoding="async"
    width="420"
    height="240">
                                    </div>
                    ...
                    <div class="rides-layout-content w-full px-3 lg:w-3/4">
                        ...
                        <div class="w-full">
                            ...
                            <!--[if BLOCK]><![endif]--><?php if($tab === 'self_drive'): ?>
                                ...
                                <!--[if BLOCK]><![endif]--><?php if($selfDrivePeriodInvalid ?? false): ?>
...
<?php elseif($selectedVehicleBooked ?? false): ?>
...
<?php else: ?>
    <div class="sd-list">
        <!--[if BLOCK]><![endif]--><?php $__empty_1 = true; $__currentLoopData = $rides; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $vehicle): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
            ...
            <article wire:key="self-drive-vehicle-<?php echo e($vehicle->id); ?>"
                ...
                <div class="sd-premium-media group">
                    <button
                        ...
                        x-on:click="openGallery(
                            <?php echo \Illuminate\Support\Js::from($vehicleGallery)->toHtml() ?>,
                            <?php echo \Illuminate\Support\Js::from($vehicle->display_name)->toHtml() ?>,
                            0
                        )"
                        aria-label="View the complete vehicle gallery for <?php echo e($vehicle->display_name); ?>"
                    >
                        <span class="sr-only">
                            View the complete vehicle gallery for <?php echo e($vehicle->display_name); ?>
                    ...
                    <img
                        ...
                        title="Open the vehicle gallery for <?php echo e($vehicle->display_name); ?> photos"
                        loading="<?php echo e($loop->first ? 'eager' : 'lazy'); ?>"
                        fetchpriority="<?php echo e($loop->first ? 'high' : 'auto'); ?>"
                        decoding="async"
                        width="420"
                    ...
                    >
                        ...
                        <span class="rounded-full bg-white/20 px-1.5 py-0.5">
                            <?php echo e(count($vehicleGallery)); ?>
                    ...
                    <span class="sd-premium-year">
                        <?php echo e((int) ($vehicle->manufacture_year ?? 0) > 0
                ...
                <div class="sd-premium-body">
                    ...
                    <div class="sd-premium-specs">
                        <span>
                            ...
                            <strong>
                                <?php echo e(filled($vehicle->fuel_type)
                        ...
                        <span>
                            ...
                            <strong>
                                <?php echo e(filled($vehicle->transmission)
                        ...
                        <span>
                            ...
                            <strong><?php echo e($vehicle->seats ?: 'N/A'); ?></strong>
                        </span>

                        <span>
                            <i class="fa-regular fa-clock"></i>
                            <small>Rental Duration</small>
                            <strong><?php echo e($selfDriveHours); ?> hrs</strong>
                        </span>
                    </div>
                    ...
                    <div class="sd-premium-policy">
                        <span>
                            ...
                            Security <?php echo e(Number::currency($securityDeposit, 'INR')); ?>
                ...
                <div class="sd-premium-booking">
                    ...
                    <!--[if BLOCK]><![endif]--><?php if($hasValidPrice): ?>
                        <div class="sd-premium-price">
                            <?php echo e(Number::currency($rentalTotal, 'INR')); ?>

                        </div>

                        <p class="sd-premium-rate">
                            <?php echo e(Number::currency($hourlyPrice, 'INR')); ?> / hour
                        </p>
                        ...
                        <div class="sd-premium-billing">
                            ...
                            <span>
                                Billable
                                <strong><?php echo e($billableHours); ?> hrs</strong>
                            </span>
                        </div>
                        ...
                        <!--[if BLOCK]><![endif]--><?php if($selfDriveHours < $minimumBookingHours): ?>
                            <p class="sd-premium-minimum">
                                ...
                                Minimum <?php echo e($minimumBookingHours); ?> hour billing applies
                            </p>
                        <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                    <?php else: ?>
                    ...
                    <button type="button"
                        ...
                        <span wire:loading.remove
                            ...
                            <?php echo e($hasValidPrice ? 'Continue with this Vehicle' : 'Currently Unavailable'); ?>
                    ...
                    <div class="mt-3 flex flex-wrap items-center justify-center gap-2">
                        ...
                        <!--[if BLOCK]><![endif]--><?php if($hasValidPrice): ?>
                            <button
                                type="button"
                                x-on:click="openSelfDriveFare(<?php echo \Illuminate\Support\Js::from([
                                ...
                                aria-label="View fare details for <?php echo e($vehicle->display_name); ?>"
...
</div><?php /**PATH C:\xampp\htdocs\duracabs\resources\views/livewire/rides-page.blade.php ENDPATH**/ ?>