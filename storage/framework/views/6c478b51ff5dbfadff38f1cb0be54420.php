<div class="w-full max-w-[85rem] py-10 px-4 sm:px-6 lg:px-8 mx-auto">
    <?php $__env->startSection('title', 'Vendor Registration - Dura Cabs Services'); ?>
    <?php $__env->startSection('description',
        'Register as a vendor with Dura Cabs to offer your services and grow your business with us. Join our network today!'); ?>
            ...
            <div class="bg-white border border-gray-200 rounded-xl shadow-sm dark:bg-gray-800 dark:border-gray-700">
                <div class="p-4 sm:p-7">
                    <div class="text-center">
                        <h1 class="block text-2xl font-bold text-gray-800 dark:text-white">Vendor Registration</h1>
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                                ...
                                <div class="lg:w-1/2 px-1">
                                    <div class="flex justify-between items-center">
                                        <label for="password"
                                            class="block text-sm mb-2 dark:text-white">Create Password</label>
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                            ...
                            <div class="lg:flex grid mt-2">
                                ...
                                <div class="lg:w-1/2 px-1">
                                    <label for="companyName" class="block text-sm mb-2 dark:text-white">Company
                                        Name</label>
                                    <div class="relative">
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                            ...
                            <button type="submit"
                                class="w-full mt-2 py-3 px-4 inline-flex justify-center items-center gap-x-2 text-sm font-semibold rounded-lg border border-transparent bg-blue-600 text-white hover:bg-blue-700 disabled:opacity-50 disabled:pointer-events-none dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600"
...
<?php /**PATH /var/www/duracabs/duracabs/resources/views/livewire/vendor-registration.blade.php ENDPATH**/ ?>