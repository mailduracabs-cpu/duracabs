...
<link rel="icon" type="image/x-icon" href="/img/logo/favicon_duracabs.ico">
    ...
    <title><?php echo $__env->yieldContent('title'); ?> <?php echo e(config('', '')); ?></title>
    ...
    <meta name="abstract" content="<?php echo $__env->yieldContent('title'); ?>">
    ...
    <meta name="web_content_type" content="<?php echo $__env->yieldContent('title'); ?>" />
    ...
    <meta property="og:title" content="<?php echo $__env->yieldContent('title'); ?> : Duracabs" />
    ...
    <meta property="twitter:description"
        content="<?php echo $__env->yieldContent('description'); ?>" />
    <meta name="twitter:title" content="<?php echo $__env->yieldContent('title'); ?> : Duracabs" />
...
$__html = app('livewire')->mount($__name, $__params, 'lw-2210399145-0', $__slots ?? [], get_defined_vars());
...
$__html = app('livewire')->mount($__name, $__params, 'lw-2210399145-1', $__slots ?? [], get_defined_vars());
...
<script type="application/ld+json">
{
 ...
 <script type="application/ld+json">
        {"@context":"https://schema.org/"
        ,"@type":"Product"
        ,"name":"<?php echo $__env->yieldContent('title'); ?> : <?php echo e(config('app.name', 'Dura Cabs')); ?> "
...
<?php /**PATH /var/www/duracabs/duracabs/resources/views/components/layouts/app.blade.php ENDPATH**/ ?>