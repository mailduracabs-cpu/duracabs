<footer class="bg-slate-950 pb-20 text-slate-300 lg:pb-0">
    <div class="mx-auto max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14">
        <div class="grid gap-10 sm:grid-cols-2 lg:grid-cols-5">
            <section class="sm:col-span-2" aria-labelledby="footer-brand-title">
                ...
                <div class="mt-5 flex gap-2" aria-label="Social media links">
                    ...
                    ]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as [$url,$icon,$label]): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <a href="<?php echo e($url); ?>" target="_blank" rel="nofollow noopener noreferrer" aria-label="<?php echo e($label); ?>" class="inline-flex h-10 w-10 items-center justify-center rounded-xl border border-white/10 bg-white/5 text-slate-300 transition hover:border-sky-400 hover:bg-sky-500 hover:text-white">
                            <i class="fa-brands <?php echo e($icon); ?>" aria-hidden="true"></i>
                        </a>
        ...
        <div class="mt-10 grid gap-4 border-t border-white/10 pt-6 lg:grid-cols-2">
            <!--[if BLOCK]><![endif]--><?php if(!empty($topRoutes) && count($topRoutes)): ?>
                <details class="group rounded-2xl border border-white/10 bg-white/[0.03] p-4">
                    ...
                    <div class="mt-4 flex flex-wrap gap-x-3 gap-y-2 text-sm">
                        <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $topRoutes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cars): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <a href="<?php echo e($cars->url); ?>" class="hover:text-sky-300"><?php echo e($cars->title); ?></a>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><!--[if ENDBLOCK]><![endif]-->
                    </div>
                </details>
            <?php endif; ?><!--[if ENDBLOCK]><![endif]-->

            <!--[if BLOCK]><![endif]--><?php if(!empty($carRental) && count($carRental)): ?>
                <details class="group rounded-2xl border border-white/10 bg-white/[0.03] p-4">
                    <summary class="flex cursor-pointer list-none items-center justify-between font-bold text-white">
                    ...
                    <div class="mt-4 flex flex-wrap gap-x-3 gap-y-2 text-sm">
                        <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $carRental; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cars): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <a href="<?php echo e($cars->url); ?>" class="hover:text-sky-300"><?php echo e($cars->title); ?></a>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><!--[if ENDBLOCK]><![endif]-->
                    </div>
                </details>
        ...
        <div class="mt-8 flex flex-col gap-3 border-t border-white/10 pt-6 text-xs text-slate-500 sm:flex-row sm:items-center sm:justify-between">
            <p>&copy; <?php echo e(now()->year); ?> Dura Cabs Services. All rights reserved.</p>
    ...
    <nav class="fixed inset-x-0 bottom-0 z-50 border-t border-slate-200 bg-white/95 px-2 pb-[env(safe-area-inset-bottom)] shadow-[0_-8px_30px_rgba(15,23,42,.12)] backdrop-blur lg:hidden" aria-label="Mobile quick actions">
        <ul class="grid grid-cols-5">
            ...
            ?>
            <li><a href="/login" wire:navigate class="<?php echo e($mobileAction); ?>"><i class="fa-regular fa-user text-lg" aria-hidden="true"></i><span>Account</span></a></li>
            <li><a href="https://api.whatsapp.com/send/?phone=917088873332&text=Hi&type=phone_number&app_absent=0" target="_blank" rel="nofollow noopener noreferrer" class="<?php echo e($mobileAction); ?>"><i class="fa-brands fa-whatsapp text-xl" aria-hidden="true"></i><span>WhatsApp</span></a></li>
            ...
            <li><a href="/vendor-register" wire:navigate class="<?php echo e($mobileAction); ?>"><i class="fa-solid fa-car-side text-lg" aria-hidden="true"></i><span>Host</span></a></li>
            <li><a href="https://tawk.to/chat/6580f88f07843602b803784b/1i37fp9vq" target="_blank" rel="nofollow noopener noreferrer" class="<?php echo e($mobileAction); ?>"><i class="fa-regular fa-comments text-lg" aria-hidden="true"></i><span>Chat</span></a></li>
        </ul>
    </nav>
</footer>
<?php /**PATH C:\xampp\htdocs\duracabs\resources\views/livewire/partials/footer.blade.php ENDPATH**/ ?>