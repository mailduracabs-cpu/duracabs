...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'filament::components.section.index','data' => ['aside' => $isAside,'collapsed' => $isCollapsed(),'collapsible' => $isCollapsible() && (! $isAside),'compact' => $isCompact(),'contentBefore' => $isContentBefore(),'description' => $getDescription(),'footerActions' => $getFooterActions(),'footerActionsAlignment' => $getFooterActionsAlignment(),'headerActions' => $getHeaderActions(),'heading' => $getHeading(),'icon' => $getIcon(),'iconColor' => $getIconColor(),'iconSize' => $getIconSize(),'persistCollapsed' => $shouldPersistCollapsed(),'attributes' => 
...
<?php endif; ?>
<?php /**PATH /var/www/duracabs/duracabs/vendor/filament/infolists/resources/views/components/section.blade.php ENDPATH**/ ?>