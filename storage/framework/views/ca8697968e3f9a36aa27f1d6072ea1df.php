...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                        ...
                        <!--[if BLOCK]><![endif]--><?php if(($cart_items[0]['type'] ?? '') !== 'self_drive'): ?>
                            <div class="grid lg:grid-cols-2 grid-rows-1 gap-4">
                                <div class="mt-4">
...
unset($__errorArgs, $__bag); ?>">
                                    <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['number_travellers'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>">
                                    <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['number_luggage'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>"></textarea>
                            <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['drop_address'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>"></textarea>
                            <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['comments'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
            ...
            <div class="md:col-span-12 lg:col-span-4 col-span-12">
                ...
                <div class="bg-white rounded-xl shadow p-4 sm:p-7 dark:bg-slate-900">
                    ...
                    <div class="flex justify-between mb-2 font-bold">
                        <span>Toll</span>
                        <span>
                            <?php echo e(($tollTax ?? 0) == 0 || ($tollTax ?? '') == ''
                    ...
                    <div class="flex justify-between mb-2 font-bold">
                        <span>Taxes (5%)</span>
                        <span><?php echo e(Number::currency($taxAmount, 'INR')); ?></span>
                    </div>

                    <hr class="bg-slate-400 my-4 h-1 rounded">

                    <!--[if BLOCK]><![endif]--><?php if(!empty($cart_items) && isset($cart_items[0]['type']) && $cart_items[0]['type'] !== 'self_drive'): ?>
                        ...
                        <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $this->extraAmountArr; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="flex justify-between mb-2 font-bold">
                                <span class="flex items-center space-x-2 gap-2 align-top">
                                    <input type="checkbox"
                                        wire:click="newWehicalValueFun(<?php echo e($key); ?>)"
                                        <?php echo e($item['is_checked'] ? 'checked' : ''); ?>
...
<div class="flex justify-between mb-2 font-bold">
                        ...
                        <span><?php echo e(Number::currency($grandTotal, 'INR')); ?></span>
                    </div>

                    <!--[if BLOCK]><![endif]--><?php if($couponData): ?>
                        <div class="flex justify-between mb-2 font-bold">
                            <span>Coupon (<?php echo e(round($couponData)); ?>%)</span>
                            <span><?php echo e(Number::currency($discountAmount, 'INR')); ?></span>
                        </div>
                    <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                    ...
                    <!--[if BLOCK]><![endif]--><?php if($availableCoupons->count() > 0): ?>
                        <div class="mb-4">
                            ...
                            <div class="space-y-2 max-h-48 overflow-y-auto">
                                <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $availableCoupons; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $availableCoupon): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="flex items-center justify-between p-3 bg-gradient-to-r from-green-50 to-blue-50 dark:from-gray-700 dark:to-gray-600 border border-green-200 dark:border-gray-600 rounded-lg hover:shadow-md transition duration-200">
                                        <div class="flex-1">
                                            <div class="flex items-center space-x-2">
                                                ...
                                                <span class="font-semibold text-gray-800 dark:text-white">
                                                    <?php echo e($availableCoupon->name); ?>
                                        ...
                                        <button type="button"
                                            wire:click="applyCoupon('<?php echo e($availableCoupon->name); ?>')"
                    ...
                    <div class="mb-4">
                        ...
                        <div class="flex space-x-2">
                            <input wire:model.live.debounce.500ms="coupon" placeholder="Enter coupon code"
                                id="coupon" type="text"
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                ...
                <button type="submit"
                    ...
                    <span wire:loading.remove wire:target="placeOrder">
                        Make Payment <?php echo e(Number::currency($grandTotal, 'INR')); ?>
                ...
                <div class="bg-white mt-4 rounded-xl shadow p-4 sm:p-7 dark:bg-slate-900">
                    ...
                    <ul class="divide-y divide-gray-200 dark:divide-gray-700" role="list">
                        <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $cart_items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ci): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <li class="py-3 sm:py-4" wire:key="<?php echo e($ci['product_id'] ?? $loop->index); ?>">
                                <div class="flex items-center">
                                    <div class="flex-1 min-w-0 ms-0 mb-2">
                                        <p><b>PickUp City</b> :</p>
                                    </div>
                                    <div><?php echo e($ci['cityFrom'] ?? ''); ?></div>
                                </div>
                                ...
                                <div class="flex items-center">
                                    ...
                                    <div><?php echo e($ci['cabModel'] ?? ''); ?></div>
                                </div>

                                <div class="flex items-center">
                                    <div class="flex-shrink-0">
                                        <img alt="<?php echo e($ci['name'] ?? 'Cab'); ?>" loading="lazy" decoding="async" class="w-12 h-12 rounded-full"
                                    ...
                                    <div class="flex-1 min-w-0 ms-4">
                                        ...
                                        <p class="text-sm text-gray-500 truncate dark:text-gray-400">
                                            Quantity: <?php echo e($ci['quantity'] ?? 1); ?>

                                        </p>
                                    </div>

                                    <div class="inline-flex items-center text-base font-semibold text-gray-900 dark:text-white">
                                        <?php echo e(Number::currency($ci['total_ammount'] ?? $ci['unit_ammount'] ?? 0, 'INR')); ?>
...
<?php /**PATH C:\xampp\htdocs\duracabs\resources\views/livewire/checkout-page.blade.php ENDPATH**/ ?>