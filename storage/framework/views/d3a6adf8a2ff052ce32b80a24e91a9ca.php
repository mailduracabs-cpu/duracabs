<div class="w-full max-w-7xl py-4 px-3 sm:px-4 lg:px-6 mx-auto">
    <?php $__env->startSection('title', 'Order Details - Duracabs'); ?>
    <?php $__env->startSection('description', 'View your order details and manage your booking'); ?>

    <!-- Compact Header -->
    <div class="mb-4">
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
            <div>
                <h1 class="text-2xl sm:text-3xl font-bold text-gray-900 dark:text-white">Order #<?php echo e($order->id); ?></h1>
                <p class="text-sm text-gray-600 dark:text-gray-400"><?php echo e($order->created_at->format('M d, Y h:i A')); ?></p>
            </div>
    ...
    <div class="grid grid-cols-2 lg:grid-cols-4 gap-3 mb-4">
        ...
        <div class="bg-white border shadow-sm rounded-lg dark:bg-slate-900 dark:border-gray-800">
            <div class="p-3 flex items-center gap-x-3">
                <div class="flex-shrink-0 w-10 h-10 <?php echo e($this->getStatusColor($order->status)); ?> rounded-lg flex items-center justify-center">
                ...
                <div class="min-w-0 flex-1">
                    ...
                    <p class="text-sm font-semibold text-gray-900 dark:text-white truncate"><?php echo e($this->getStatusText($order->status)); ?></p>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white border shadow-sm rounded-lg dark:bg-slate-900 dark:border-gray-800">
            <div class="p-3 flex items-center gap-x-3">
                <div class="flex-shrink-0 w-10 h-10 <?php echo e($order->payment_status === 'paid' ? 'bg-green-500' : ($order->payment_status === 'pending' ? 'bg-yellow-500' : 'bg-red-500')); ?> rounded-lg flex items-center justify-center">
                    <svg class="w-5 h-5 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div class="min-w-0 flex-1">
                    ...
                    <p class="text-sm font-semibold text-gray-900 dark:text-white truncate"><?php echo e(ucfirst($order->payment_status)); ?></p>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white border shadow-sm rounded-lg dark:bg-slate-900 dark:border-gray-800">
            <div class="p-3 flex items-center gap-x-3">
                ...
                <div class="min-w-0 flex-1">
                    ...
                    <p class="text-sm font-semibold text-gray-900 dark:text-white">₹<?php echo e(number_format($order->grand_total)); ?></p>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white border shadow-sm rounded-lg dark:bg-slate-900 dark:border-gray-800">
            <div class="p-3 flex items-center gap-x-3">
                ...
                <div class="min-w-0 flex-1">
                    ...
                    <p class="text-sm font-semibold text-gray-900 dark:text-white truncate"><?php echo e($rideDetails['title']); ?></p>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="bg-white border shadow-sm rounded-lg dark:bg-slate-900 dark:border-gray-800">
                <div class="px-4 py-3 border-b border-gray-200 dark:border-gray-700">
                    <h3 class="text-lg font-semibold text-gray-800 dark:text-gray-200 flex items-center">
                        ...
                        <?php echo e($rideDetails['title']); ?> Details
                    </h3>
                </div>
                <div class="p-4">
                    <div class="grid grid-cols-1 gap-4">
                        <?php $__currentLoopData = $rideDetails['fields']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $label => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php if($value): ?>
                            <div>
                                <label class="block text-xs font-medium text-gray-500 uppercase tracking-wide mb-1"><?php echo e($label); ?></label>
                                <p class="text-gray-900 dark:text-white font-semibold"><?php echo e($value); ?></p>
                            </div>
                            <?php endif; ?>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </div>

                    <?php if($order->taxi_type || $order->productName): ?>
                    <div class="mt-4 pt-4 border-t border-gray-200">
                        <div class="grid grid-cols-1 gap-4">
                            <?php if($order->taxi_type): ?>
                            <div>
                                <label class="block text-xs font-medium text-gray-500 uppercase tracking-wide mb-1">Vehicle Type</label>
                                <p class="text-gray-900 dark:text-white font-semibold"><?php echo e($order->taxi_type); ?></p>
                            </div>
                            <?php endif; ?>
                            <?php if($order->productName): ?>
                            <div>
                                <label class="block text-xs font-medium text-gray-500 uppercase tracking-wide mb-1">Service</label>
                                <p class="text-gray-900 dark:text-white font-semibold"><?php echo e($order->productName); ?></p>
                            </div>
                            <?php endif; ?>
                        </div>
                    </div>
                ...
                <div class="p-4">
                    ...
                    <div class="flex items-center justify-between py-3 <?php echo e(!$loop->last ? 'border-b border-gray-100' : ''); ?>">
                        <div class="flex items-center min-w-0 flex-1">
                            <?php if($item->order->image): ?>
                            <img class="h-10 w-10 rounded-lg object-cover mr-3 flex-shrink-0" 
                                 src="<?php echo e(url('storage')); ?>/<?php echo e($item->order->image); ?>" 
                                 alt="<?php echo e($item->order->productName ?? $item->name); ?>">
                            <?php else: ?>
                            ...
                            <div class="min-w-0 flex-1">
                                <p class="font-semibold text-gray-900 dark:text-white text-sm truncate">
                                    <?php echo e($item->order->productName ?? $item->name); ?>

                                </p>
                                <p class="text-xs text-gray-500">₹<?php echo e(number_format($item->unit_ammount)); ?> × 1</p>
                            </div>
                        </div>
                        <div class="text-right flex-shrink-0 ml-3">
                            <p class="font-semibold text-gray-900 dark:text-white">₹<?php echo e(number_format($item->total_ammount)); ?></p>
                        </div>
                    </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </div>
                ...
                <div class="p-4">
                    <div class="grid grid-cols-1 gap-4">
                        <div>
                            ...
                            <p class="text-gray-900 dark:text-white font-semibold"><?php echo e($address->full_name); ?></p>
                        </div>
                        <div>
                            <label class="block text-xs font-medium text-gray-500 uppercase tracking-wide mb-1">Phone</label>
                            <p class="text-gray-900 dark:text-white font-semibold"><?php echo e($address->phone); ?></p>
                        </div>
                        <div>
                            <label class="block text-xs font-medium text-gray-500 uppercase tracking-wide mb-1">Email</label>
                            <p class="text-gray-900 dark:text-white font-semibold"><?php echo e($address->email); ?></p>
                        </div>
                        ...
                        <div>
                            ...
                            <p class="text-gray-900 dark:text-white font-semibold"><?php echo e($address->phone2); ?></p>
                        </div>
                        <?php endif; ?>
                    </div>
                    
                    <?php if($address->pickup_address || $address->drop_address || $address->comments): ?>
                    <div class="mt-4 pt-4 border-t border-gray-200 space-y-3">
                        <?php if($address->pickup_address): ?>
                        <div>
                            <label class="block text-xs font-medium text-gray-500 uppercase tracking-wide mb-1">Pickup Address</label>
                            <p class="text-gray-900 dark:text-white font-medium"><?php echo e($address->pickup_address); ?></p>
                        </div>
                        <?php endif; ?>
                        <?php if($address->drop_address): ?>
                        <div>
                            <label class="block text-xs font-medium text-gray-500 uppercase tracking-wide mb-1">Drop Address</label>
                            <p class="text-gray-900 dark:text-white font-medium"><?php echo e($address->drop_address); ?></p>
                        </div>
                        <?php endif; ?>
                        <?php if($address->comments): ?>
                        <div>
                            <label class="block text-xs font-medium text-gray-500 uppercase tracking-wide mb-1">Special Instructions</label>
                            <p class="text-gray-900 dark:text-white font-medium"><?php echo e($address->comments); ?></p>
                        </div>
                        <?php endif; ?>
                    </div>
                    <?php endif; ?>
            ...
            <div class="bg-white border shadow-sm rounded-lg dark:bg-slate-900 dark:border-gray-800">
                ...
                <div class="p-4 space-y-3">
                    <div class="flex justify-between text-sm">
                        ...
                        <span class="font-medium">₹<?php echo e(number_format($order->grand_total - ($order->shipping_ammount ?? 0))); ?></span>
                    </div>
                    <?php if($order->shipping_ammount): ?>
                    <div class="flex justify-between text-sm">
                        <span class="text-gray-600">Service Charges</span>
                        <span class="font-medium">₹<?php echo e(number_format($order->shipping_ammount)); ?></span>
                    </div>
                    <?php endif; ?>
                    <?php if($order->coupon_value): ?>
                    <div class="flex justify-between text-sm text-green-600">
                        <span>Discount (<?php echo e($order->coupon_name); ?>)</span>
                        <span>-₹<?php echo e(number_format($order->coupon_value)); ?></span>
                    </div>
                    <?php endif; ?>
                    <hr class="border-gray-200 dark:border-gray-700">
                    <div class="flex justify-between font-semibold">
                        <span>Total Amount</span>
                        <span>₹<?php echo e(number_format($order->grand_total)); ?></span>
                    </div>
                        ...
                        <div class="flex items-center">
                            ...
                            <div class="min-w-0 flex-1">
                                <div class="flex justify-between items-center">
                                    ...
                                    <p class="text-xs text-gray-500"><?php echo e($order->created_at->format('M d, h:i A')); ?></p>
                                </div>
                            </div>
                        </div>
                        
                        <?php if(in_array($order->status, ['confirm', 'start', 'closed'])): ?>
                        <div class="flex items-center">
                            ...
                            <div class="min-w-0 flex-1">
                                <div class="flex justify-between items-center">
                                    ...
                                    <p class="text-xs text-gray-500"><?php echo e($order->updated_at->format('M d, h:i A')); ?></p>
                                </div>
                            </div>
                        </div>
                        <?php endif; ?>
                        
                        <?php if(in_array($order->status, ['start', 'closed'])): ?>
                        <div class="flex items-center">
            ...
            <div class="mt-3">
                ...
                <div class="mt-2 px-7 py-3">
                    ...
                    <div class="mt-4">
                        ...
                        <?php $__errorArgs = ['modificationDetails'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <span class="text-red-500 text-sm"><?php echo e($message); ?></span> <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
    ...
    <?php endif; ?>
</div><?php /**PATH /var/www/duracabs/duracabs/resources/views/livewire/my-order-detail-page.blade.php ENDPATH**/ ?>