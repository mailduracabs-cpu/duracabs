...
<?php endif; ?>
                    ...
                    <?php if($areGroupingSettingsVisible): ?>
...
<?php endif; ?>
                ...
                <?php if($isGlobalSearchVisible || $hasFiltersDialog || $hasColumnToggleDropdown): ?>
...
<?php endif; ?>
                        ...
                        <?php if($hasFiltersDialog || $hasColumnToggleDropdown): ?>
                            <?php if($hasFiltersDialog): ?>
        ...
        >
            <?php if(($content || $hasColumnsLayout) && ($records !== null) && count($records)): ?>
                <?php if(! $isReordering): ?>
                    ...
                    <?php if($isSelectionEnabled || count($sortableColumns)): ?>
                        <div
...
<?php $component->withAttributes(['reorderable' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($isReorderable),'reorder-animation-duration' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($getReorderAnimationDuration())]); ?>
                    <?php if($hasColumnGroups): ?>
                         <?php $__env->slot('headerGroups', null, []); ?> 
                            ...
                            <?php $__currentLoopData = $columnsLayout; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $columnGroup): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php if($columnGroup instanceof Column): ?>
                                    <?php if($columnGroup->isVisible() && (! $columnGroup->isToggledHidden())): ?>
                                        <th></th>
                                    <?php endif; ?>
                                <?php elseif($columnGroup instanceof ColumnGroup): ?>
                                    ...
                                    <?php if($columnGroupColumnsCount): ?>
                                        <th
...
<?php $component->withAttributes(['class' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(\Illuminate\Support\Arr::toCssClasses([
                                    ...
                                    <?php if($isIndividuallySearchable): ?>
                                        <?php if (isset($component)) { $__componentOriginal7ccc00a3eaa8946ec9c0ec17f5ab229b = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal7ccc00a3eaa8946ec9c0ec17f5ab229b = $attributes; } ?>
...
<?php endif; ?>
        ...
        <?php if((($records instanceof \Illuminate\Contracts\Pagination\Paginator) || ($records instanceof \Illuminate\Contracts\Pagination\CursorPaginator)) &&
...
<?php /**PATH /var/www/duracabs/duracabs/vendor/filament/tables/resources/views/index.blade.php ENDPATH**/ ?>