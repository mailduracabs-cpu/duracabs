            ...
            <div id="navbar-collapse-with-animation"
                ...
                <div
                    ...
                    <div
                        ...
                        <a wire:navigate
                            class="font-medium {{ request()->is('/') ? 'text-sky-100' : 'text-white ' }} hover:text-blue-800 py-3 md:py-6 dark:text-blue-500 dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600"
                            href="/" aria-current="page">Home</a>

                        <a 
                            class="font-medium {{ request()->is('cab-categories') ? 'text-sky-100' : 'text-white ' }} hover:text-blue-800 py-3 md:py-6 dark:text-gray-400 dark:hover:text-gray-500 dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600"
                            href="tel:7088873331">
                            Call:+91-7088873331
                        </a>

                        <a
                            class="font-medium {{ request()->is('rides') ? 'text-sky-100' : 'text-white ' }} hover:text-blue-800 py-3 md:py-6 dark:text-gray-400 dark:hover:text-gray-500 dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600"
                            href="https://api.whatsapp.com/send/?phone=917088873331&text&type=phone_number&app_absent=0" rel="noindex">
                            Whatsapp
                        </a>

                        {{-- <a wire:navigate
                            class="font-medium flex items-center {{ request()->is('cart') ? 'text-sky-100' : 'text-white ' }}  hover:text-blue-800 py-3 md:py-6 dark:text-gray-400 dark:hover:text-gray-500 dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600"
                            href="/cart">
                            ...
                            <span class="mr-1">Rides</span> <span
                                class="py-0.5 px-1.5 rounded-full text-xs font-medium bg-blue-50 border border-blue-200 text-blue-600">{{ $total_count }}</span>
                        </a> --}}

                        <a wire:navigate
                            class="font-medium flex items-center {{ request()->is('cart') ? 'text-sky-100' : 'text-white ' }}   hover:text-blue-600 py-3 md:py-6 dark:text-gray-400 dark:hover:text-gray-500 dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600"
