<div class="w-full max-w-[85rem] py-10 px-4 sm:px-6 lg:px-8 mx-auto">
    @section('title', 'User Login - Dura Cabs Services')
    @section('description',
                    ...
                    <div class="p-5">
                        <div class="mb-4 text-center">
                            <div class="mx-auto mb-4 rounded-2xl flex items-center justify-center">
                                <img class="w-50" src="{{ asset('./img/loginimg.jpg') }}" alt="login"/>
                            </div>
                        ...
                        <div class="grid gap-y-4">
                            ...
                            <form wire:submit.prevent='save'>
                                <div class="{{ $sendOtp ? 'hidden' : '' }}">
                                    ...
                                    @enderror
                                    <button type="{{ strlen($mobile) == 10 ? 'submit' : 'button' }} "
                            ...
                            <form wire:submit.prevent='verifySubmitOtp'>
                                <div class="{{ $sendOtp ? '' : 'hidden' }}">
                                    ...
                                    @error($otpError)
                                        <p class=" text-xs text-red-600 mt-2" id="otp-error">{{ $otpError }}</p>
                                    @enderror
                            ...
                            <a class="inline-flex justify-center items-center" href="{{ url('auth/google') }}" rel="nofollow">
                                <img src="{{ asset('img/google.png') }}" alt="google"style="width:200px">
                            </a>
                        </div>
