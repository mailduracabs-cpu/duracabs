        ...
        <div class="grid grid-cols-12 gap-4">
            ...
            <div class="md:col-span-12 lg:col-span-4 col-span-12">
                ...
                <div class="bg-white rounded-xl shadow p-4 sm:p-7 dark:bg-slate-900">
                    ...
                    <div class="flex justify-between mb-2 font-bold">
                        <span>Taxes (5%)</span>
                        <span>{{ Number::currency($taxAmount, 'INR') }}</span>
                    </div>
...
<div class="flex justify-between mb-2 font-bold">
                    ...
                    @if ($couponData)
                        <div class="flex justify-between mb-2 font-bold">
                            ...
                            <span>{{ Number::currency($discountAmount, 'INR') }}</span>
                        </div>
                    @endif
                ...
                <button type="submit"
                    ...
                    <span wire:loading.remove wire:target="placeOrder">
                        Make Payment {{ Number::currency($grandTotal, 'INR') }}
                    </span>
                            ...
                            <li class="py-3 sm:py-4" wire:key="{{ $ci['product_id'] ?? $loop->index }}">
                                ...
                                <div class="flex items-center">
                                    <div class="flex-shrink-0">
                                        <img alt="{{ $ci['name'] ?? 'Cab' }}" loading="lazy" decoding="async" class="w-12 h-12 rounded-full"
