<div class="">
    ...
    <div class="w-full py-10 px-2" style='background: linear-gradient(180deg,rgb(30, 156, 253) 0%, rgb(255, 255, 255) 98%);'
        ...
        <div class="pt-6">
            <h2 class="font-extrabold text-4xl text-center text-white hidden md:block">Hot Deals In {{ $page->name }}</h2>
        </div>
        ...
        <div class="w-full from-blue-200 to-cyan-200 py-5 px-4 sm:px-6 lg:px-8 mx-auto">
            <div class="max-w-[85rem] mx-auto px-0 sm:px-6 lg:px-8">
                ...
                <div class="grid md:grid-cols-1 gap-0 md:gap-8 xl:gap-20 md:items-center">
                                    ...
                                    <div class="rounded-2xl border border-gray-200 bg-white p-8 shadow-xl shadow-gray-100/80">
                                        ...
                                        <div class="mb-8 text-center">
                                            <div class="mx-auto mb-4 rounded-2xl flex items-center justify-center">
                                                <img fetchpriority="high"  class="w-96" src="{{ asset('./img/loginimg.jpg') }}" alt="login" />
                                            </div>
                                                ...
                                                <div class="flex">
                                                    ...
                                                    <div class="w-full text-center sm:ml-4 sm:mt-0 sm:text-left">
                                                        ...
                                                        <div class="mt-2 w-full">
                                                            ...
                                                            <p class="mt-2 text-red-900 text-sm"> {{ strlen($mobileNumber)  == 10  ? '' : 'Kindly put 10 digit' }}</p>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                ...
                                <div
                                    ...
                                    <div class="mb-8 text-center">
                                        <div class="mx-auto rounded-2xl flex items-center justify-center">
                                            <img fetchpriority="high"  class="w-96" src="{{ asset('./img/passwordimg.jpg') }}" alt="password" />
                                        </div>
                            ...
                            <div class="lg:flex grid mx-0 w-full ">
                                ...
                                <div class="lg:w-1/4 md:mt-0 mt-3">
                                    ...
                                    @if($this->hasError('query2'))
                                        <div class="mt-1">
                                            <p class="text-sm text-red-600">{{ $this->getError('query2') }}</p>
                                        </div>
                                    @endif
                                    ...
                                    <div class="lg:mt-3 w-full lg:inline-flex">
                                        <div class="lg:w-1/5 md:mt-0 mt-4">
                                            ...
                                            @if($this->hasError('queryFrom'))
                                                <div class="mt-1">
                                                    <p class="text-sm text-red-600">{{ $this->getError('queryFrom') }}</p>
                                                </div>
                                            @endif
                                        ...
                                        <div class="lg:w-1/5 md:mt-0 mt-3">
                                            ...
                                            @if($this->hasError('queryTo'))
                                                <div class="mt-1">
                                                    <p class="text-sm text-red-600">{{ $this->getError('queryTo') }}</p>
                                                </div>
                                            @endif
                                        ...
                                        <div class="lg:w-1/5 md:mt-0 mt-3">
                                            ...
                                            <input type="date" wire:model='dateto' id="simple-search" min="<?php echo date('Y-m-d');?>"
                                                class="arriveDate lg:mt-3 bg-gray-50 border {{ $this->hasError('dateto') ? 'border-red-500 focus:ring-red-500 focus:border-red-500' : 'border-gray-300 focus:ring-blue-500 focus:border-blue-500' }} lg:py-[40px] text-black font-extrabold lg:text-2xl text-xm block w-full ps-2 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                                placeholder="date" required />
                                            @if($this->hasError('dateto'))
                                                <div class="mt-1">
                                                    <p class="text-sm text-red-600">{{ $this->getError('dateto') }}</p>
                                                </div>
                                            @endif
                                        </div>
                                        ...
                                        <div class="lg:w-1/5 md:mt-0 mt-3">
                                            ...
                                            <input type="time" wire:model='time' id="simple-search"
                                                class="arriveTime lg:mt-3 bg-gray-50 border {{ $this->hasError('time') ? 'border-red-500 focus:ring-red-500 focus:border-red-500' : 'border-gray-300 focus:ring-blue-500 focus:border-blue-500' }} lg:py-[40px] text-black font-extrabold lg:text-2xl text-xm block w-full ps-2 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                                placeholder="date" required />
                                            @if($this->hasError('time'))
                                                <div class="mt-1">
                                                    <p class="text-sm text-red-600">{{ $this->getError('time') }}</p>
                    ...
                    <img fetchpriority="high"  class="w-full rounded-md" src="https://www.duracabs.com/home_back.png" alt="Image Description">
                    <div
                ...
                <div x-ref="container" class="-ml-4 flex overflow-x-scroll scroll-snap-x space-x-4 md:space-y-0 ">
                    ...
                    @foreach ($carousel as $item)
                        <a href="{{ $item->url }}"
                            ...
                            <div><img fetchpriority="high"  src="{{ url('storage') }}/{{ $item->image }}" alt="Duracabs {{$item->name}}"></div>
    ...
    <div class="max-w-[70rem] mx-auto">
        ...
        {{-- Slider Section End --}}
        {{-- <img fetchpriority="high"  src="/img/page/pages_banner.webp" width="100%" /> --}}
                                        ...
                                        <div
                                            ...
                                            <div class="flex items-center mb-2 md:mb-0 ">
                                                <div class="flex mr-2 rounded-full">
                                                    <img fetchpriority="high"  src="{{ url('storage') }}/{{ $review->image }}" alt="Duracabs {{$review->name}}"
        ...
        @if (!$page->brand_id = 112)
      
        
            <section class="py-10 lg:mx-20 mx-5">
                <div class="">
                    <h2 class="text-2xl">Why choose Duracabs for cabs in {{ $page->brand->name }} ?</h2>
                </div>
                    ...
                    <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                        ...
                        <tbody>
                            ...
                            @foreach ($page->link_products as $item)
                                <tr class="border-b border-gray-200 dark:border-gray-700">
                                    <td class="px-6 py-4"><strong>{{ $item['name'] }}</strong></td>
                                    <td class="px-6 py-4"><strong>{{ $item['oneway'] }}</strong></td>
                                    <td class="px-6 py-4"><strong>{{ $item['perKM'] }}</strong></td>
                                </tr>
                            @endforeach
                    ...
                    <div class="flex flex-col divide-y sm:px-0 lg:px-2 xl:px-4 divide-gray-700">
                        <details>
                            <summary class="py-2 outline-none cursor-pointer focus:underline">1. What is the minimum
                                price
                                Taxi Services in {{ $page->name }} ?</summary>
                            <div class="px-4 pb-4">
                        ...
                        <details>
                            <summary class="py-2 outline-none cursor-pointer focus:underline">2. How to book Taxi
                                Services
                                in {{ $page->name }} from DuraCabs ?</summary>
                            <div class="px-4 pb-4">
                        ...
                        <details>
                            <summary class="py-2 outline-none cursor-pointer focus:underline">3. What documents are
                                required to book a Taxi Services in {{ $page->name }} ?</summary>
                            <div class="px-4 pb-4">
                        ...
                        <div x-ref="container"
                            ...
                            @foreach ($products as $product)
                                <div class="ml-4 flex-auto flex-grow-0 flex-shrink-0 lg:w-96 w-52 rounded-lg bg-gray-100 items-center justify-center snap-center overflow-hidden shadow-md"
                                    wire:key='{{ $product->id }}'>
                                    <a href="/route/{{ $product->slug }}" class="">
                                        <img fetchpriority="high"  src="{{ url('storage') }}/{{ $product->images[0] }}"
            ...
            <ul class="flex text-sm font-medium text-center text-gray-500 rounded-lg shadow mb-4">
                ...
                {{-- <div class="mb-6">
                    <ul class="flex text-sm font-medium text-center text-gray-500 rounded-lg shadow">
                        <li class="w-1/4">
                            <button wire:click='changeEditTab("one_way")'
                                class="flex items-center justify-center w-full p-3 text-gray-900 bg-gray-100 border-r border-gray-200 rounded-l-lg {{ $edit_ride_type === 'one_way' ? 'bg-blue-600 text-white' : 'hover:bg-gray-50' }} transition duration-200">
                                <span class="font-bold text-xs uppercase">One Way</span>
                            </button>
                        </li>
                        <li class="w-1/4">
                            <button wire:click='changeEditTab("return")'
                                class="flex items-center justify-center w-full p-3 text-gray-900 bg-gray-100 border-r border-gray-200 {{ $edit_ride_type === 'return' ? 'bg-blue-600 text-white' : 'hover:bg-gray-50' }} transition duration-200">
                                <span class="font-bold text-xs uppercase">Return</span>
                            </button>
                        </li>
                        <li class="w-1/4">
                            <button wire:click='changeEditTab("local")'
                                class="flex items-center justify-center w-full p-3 text-gray-900 bg-gray-100 border-r border-gray-200 {{ $edit_ride_type === 'local' ? 'bg-blue-600 text-white' : 'hover:bg-gray-50' }} transition duration-200">
                                <span class="font-bold text-xs uppercase">Local</span>
                            </button>
                        </li>
                        <li class="w-1/4">
                            <button wire:click='changeEditTab("self_drive")'
                                class="flex items-center justify-center w-full p-3 text-gray-900 bg-gray-100 rounded-r-lg {{ $edit_ride_type === 'self_drive' ? 'bg-blue-600 text-white' : 'hover:bg-gray-50' }} transition duration-200">
                                <span class="font-bold text-xs uppercase">Self Drive</span>
                            </button>
                        </li>
                    </ul>
                ...
                <!-- One Way Form -->
                <form wire:submit='updateQuery' autocomplete="off" class="{{ $edit_ride_type == 'one_way' ? 'block' : 'hidden' }}">
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                        ...
                        <div class="relative">
                            ...
                            <div class="absolute z-20 w-full bg-white rounded-lg shadow-lg mt-1 max-h-40 overflow-y-auto">
                                ...
                                <button type="button" wire:click='editUpdate1("{{ $city['name'] }}", {{ $city['id'] }})'
                            ...
                            @endif
                            @error('edit_query_search') <span class="text-red-500 text-sm">{{ $message }}</span> @enderror
                        </div>
                        ...
                        <div class="relative">
                            ...
                            <div class="absolute z-20 w-full bg-white rounded-lg shadow-lg mt-1 max-h-40 overflow-y-auto">
                                ...
                                <button type="button" wire:click='editUpdate2("{{ $city['name'] }}", {{ $city['id'] }})'
                                    class="block w-full text-left px-4 py-2 text-sm hover:bg-blue-500 hover:text-white cursor-pointer border-b border-gray-100 last:border-b-0">
                                    {{ $city['name'] }}
                                </button>
                                @endforeach
                            ...
                            @endif
                            @error('edit_query2_search') <span class="text-red-500 text-sm">{{ $message }}</span> @enderror
                        </div>
                        ...
                        <div>
                            ...
                            <input type="date" wire:model='edit_date'
                                class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500" />
                            @error('edit_date') <span class="text-red-500 text-sm">{{ $message }}</span> @enderror
                        </div>
                        ...
                        <div>
                            ...
                            <input type="time" wire:model='edit_time'
                                class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500" />
                            @error('edit_time') <span class="text-red-500 text-sm">{{ $message }}</span> @enderror
                        </div>
                    </div>
                </form>

                <!-- Return Form -->
                <form wire:submit='updateQuery' autocomplete="off" class="{{ $edit_ride_type == 'return' ? 'block' : 'hidden' }}">
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4">
                        ...
                        <div class="relative">
                            ...
                            <div class="absolute z-20 w-full bg-white rounded-lg shadow-lg mt-1 max-h-40 overflow-y-auto">
                                ...
                                <button type="button" wire:click='editUpdateCityFrom("{{ $prediction['description'] }}")'
                                    class="block w-full text-left px-4 py-2 text-sm hover:bg-blue-500 hover:text-white cursor-pointer border-b border-gray-100 last:border-b-0">
                            ...
                            @endif
                            @error('edit_queryFrom_search') <span class="text-red-500 text-sm">{{ $message }}</span> @enderror
                        </div>
                        ...
                        <div class="relative">
                            ...
                            <div class="absolute z-20 w-full bg-white rounded-lg shadow-lg mt-1 max-h-40 overflow-y-auto">
                                ...
                                <button type="button" wire:click='editUpdateCityTo("{{ $prediction['description'] }}")'
                                    class="block w-full text-left px-4 py-2 text-sm hover:bg-blue-500 hover:text-white cursor-pointer border-b border-gray-100 last:border-b-0">
                                    {{ $prediction['description'] }}
                                </button>
                                @endforeach
                            ...
                            @endif
                            @error('edit_queryTo_search') <span class="text-red-500 text-sm">{{ $message }}</span> @enderror
                        </div>
                        ...
                        <div>
                            ...
                            <input type="date" wire:model='edit_dateto'
                                class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500" />
                            @error('edit_dateto') <span class="text-red-500 text-sm">{{ $message }}</span> @enderror
                        </div>
                ...
                <!-- Local Form -->
                <form wire:submit='updateQuery' autocomplete="off" class="{{ $edit_ride_type == 'local' ? 'block' : 'hidden' }}">
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                        <!-- From City -->
                        <div class="relative">
                            <label class="block text-sm font-semibold text-gray-700 mb-2">From City</label>
                            ...
                            <div class="absolute z-20 w-full bg-white rounded-lg shadow-lg mt-1 max-h-40 overflow-y-auto">
                                @foreach ($edit_cities_from as $city)
                                <button type="button" wire:click='editUpdate3("{{ $city['name'] }}", {{ $city['id'] }})'
                                    class="block w-full text-left px-4 py-2 text-sm hover:bg-blue-500 hover:text-white cursor-pointer border-b border-gray-100 last:border-b-0">
                                    {{ $city['name'] }}
                                </button>
                                @endforeach
                            ...
                            @endif
                            @error('edit_queryLocal') <span class="text-red-500 text-sm">{{ $message }}</span> @enderror
                        </div>
                        ...
                        <div>
                            ...
                            @error('edit_plan') <span class="text-red-500 text-sm">{{ $message }}</span> @enderror
                        </div>
                        ...
                        <div>
                            ...
                            <input type="number" wire:model='edit_cars' min="1" placeholder="No. of cars"
                                class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500" />
                            @error('edit_cars') <span class="text-red-500 text-sm">{{ $message }}</span> @enderror
                        </div>
                ...
                <!-- Self Drive Form -->
                <form wire:submit='updateQuery' autocomplete="off" class="{{ $edit_ride_type == 'self_drive' ? 'block' : 'hidden' }}">
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4">
                        <!-- From City -->
                        <div class="relative">
                            <label class="block text-sm font-semibold text-gray-700 mb-2">From City</label>
                            ...
                            <div class="absolute z-20 w-full bg-white rounded-lg shadow-lg mt-1 max-h-40 overflow-y-auto">
                                @foreach ($edit_cities_from as $city)
                                <button type="button" wire:click='editUpdate4("{{ $city['name'] }}", {{ $city['id'] }})'
                                    class="block w-full text-left px-4 py-2 text-sm hover:bg-blue-500 hover:text-white cursor-pointer border-b border-gray-100 last:border-b-0">
                                    {{ $city['name'] }}
                                </button>
                                @endforeach
                            ...
                            @endif
                            @error('edit_querySelfDrive') <span class="text-red-500 text-sm">{{ $message }}</span> @enderror
                        </div>
                        ...
                        <div>
                            ...
                            <input type="time" wire:model='edit_endTime'
                                class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500" />
                            @error('edit_endTime') <span class="text-red-500 text-sm">{{ $message }}</span> @enderror
                        </div>
                    </div>
                </form>
