...
>
    {{-- 
        Hidden compatibility banner:
        existing cookie-consent JavaScript can still find its normal selectors,
        but this banner is never shown automatically.
    --}}
    <section
    ...
    {{-- Preferences open only when the customer clicks Cookie Settings --}}
    <section
