...
return new class extends Migration
{
    public function up(): void
    {
        ...
        */
        ...
        $foreignKeyExists = DB::table('information_schema.TABLE_CONSTRAINTS')
            ...
            ->where('TABLE_NAME', 'whats_app_messages')
            ->where(
                'CONSTRAINT_NAME',
                'whats_app_messages_whats_app_conversation_id_foreign'
            )
    ...
    public function down(): void
    {
        ...
        */
        ...
        /*
        |--------------------------------------------------------------------------
        | Drop WhatsApp Message Columns Safely
        |--------------------------------------------------------------------------
        */
        ...
        foreach ($messageColumns as $column) {
            if (Schema::hasColumn('whats_app_messages', $column)) {
                Schema::table('whats_app_messages', function (Blueprint $table) use ($column) {
        ...
        /*
        |--------------------------------------------------------------------------
        | Drop WhatsApp Conversation Columns Safely
        |--------------------------------------------------------------------------
        */
        ...
        foreach ($conversationColumns as $column) {
            if (Schema::hasColumn('whats_app_conversations', $column)) {
                Schema::table('whats_app_conversations', function (Blueprint $table) use ($column) {
                    $table->dropColumn($column);
                });
            }
        }
