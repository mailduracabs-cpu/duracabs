...
BODY,
    ...
    private function template(
        ...
        return [
            ...
            'event_key' => str_replace('_', '.', $templateKey),
            'category' => $category,
            'language' => $language,
    ...
    private function seedNotificationRules(): void
    {
        $rules = [
            ...
            [
                'name' => 'Self Drive Booking Received',
                'event_key' => 'selfdrive.booking.received',
                'template_key' =>
            ...
            [
                'name' => 'Self Drive Booking Confirmed',
                'event_key' => 'selfdrive.booking.confirmed',
                'template_key' =>
            ...
            [
                'name' => 'Self Drive Pickup Reminder',
                'event_key' => 'selfdrive.pickup.reminder',
                'template_key' =>
            ...
            [
                'name' => 'Self Drive Return Reminder',
                'event_key' => 'selfdrive.return.reminder',
                'template_key' =>
